...
var queryApi = /* @__PURE__ */ (function() {
  var _ref = _asyncToGenerator(function* () {
    try {
      ...
      let response;
      if (store.getObject(cacheKey)) {
        response = store.getObject(cacheKey);
      } else {
        response = yield api.get(parameters);
        store.setObject(cacheKey, response, 60 * 10);
      }
      return response;
    } catch (error) {
